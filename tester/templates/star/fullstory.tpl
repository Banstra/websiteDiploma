...
<article class="fullstory" itemprop="mainEntity" itemscope itemtype="https://schema.org/Article">
        <div class="mb-4">
            ...
            <div class="mb-2">
                <div class="head_info">
                    <span class="author_unb" itemprop="author" itemscope="" itemtype="https://schema.org/Person"><img alt="Avatar {login}" src="{avatar}" height="34" width="34"><span itemprop="name">[profile]{login}[/profile]</span></span> 
                    <span>
    ...
    [xfgiven_attachment]<div class="downloads">
    <div style="text-align:center;"><img width="400" height="80" style="object-fit: contain; max-width: 100%; height: auto;" src="/uploads/posts/2021-12/cursor.png" alt="Указатель на скачивание"></div>
    [xfvalue_attachment]
</div>[/xfgiven_attachment]
[xfgiven_version]<div class="support-version">
    <div class="item-content">
    <p class="version-title">Поддерживаемые версии</p>
    <span>[xfvalue_version]</span>
    </div>
</div>[/xfgiven_version]
<div class="relateds">
    <div class="card">
