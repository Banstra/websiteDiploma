...
<article class="fullstory" itemprop="mainEntity" itemscope itemtype="https://schema.org/Article">
    ...
    [xfgiven_seeds]<div class="seeds">
    <div style="text-align:center;"><img width="400" height="80" style="object-fit: contain; max-width: 100%; height: auto;" src="/uploads/posts/2021-12/cursor-seeds.png" alt="Указатель на ключ генерации"></div>
    <div class="mark-text">
        <i class="fas fa-key"></i>
        <div class="seeds-key-text">[xfvalue_seeds]</div>
    </div>
</div>[/xfgiven_seeds]
